...
public class User extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    TextView nickname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nickname.setText("歡迎用戶 "+preferenceManager.getString("name"));
        ...
        test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), UserSchedulePage.class);
                startActivity(intent);
    ...
    public void signOut(){
        showToast("Signing out successful");
