                ...
                WHERE `booking`.`status` = 0 OR `booking`.`status` = 1 ;";
                  ...
                  ?>
                    <tr>
                      ...
                      <td scope="row" onclick="window.location='details.php?id=<?php echo $rc['id'] ?>';"><?php echo $rc['people'] ?></td>
                      <td scope="row" onclick="window.location='details.php?id=<?php echo $rc['id'] ?>';"><?php if ($rc['table'] == null) {echo "不適用";} else {echo $rc['table'];}?></td>
                      <td scope="row"><?php
                                      if ($rc['table'] == null) {
                                        echo "不適用";
                                      } else {
