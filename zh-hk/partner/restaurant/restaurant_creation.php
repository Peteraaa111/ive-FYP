...
<head>
  ...
  <script src="/js/partner/restaurant_creation.js"></script>
              ...
              <div class="col-md-10 offset-1 card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-5">
                      <input class="form-control" type="tel" name="phoneNo" id="phoneNo" placeholder="聯絡電話" minlength="8" maxlength="8" oninput="value=value.replace(/[^\d]/g,'')">
                    </div>
                    <div class="col-md-5">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-end">
                      <button type="button" class="btn btn-primary" onclick="createRestaurant('<?php echo $_SESSION['r_id'] ?>');">提交</button>
                    </div>
                  </div>
                </div>
              </div>
