...
<head>
  ...
  <title>提交新餐廳資訊 - 香港本地旅遊平台 | 本地遊</title>
...
<body>
  ...
  <!-- Main Content -->
  <form id="discover_restaurant-form" enctype="multipart/form-data">
    <div class="container card">
      <div class="card-body">
        <div class="row card">
          <div class="card-body">
            <div class="col">
              如果發現一個地方是值得成為一個「餐廳」，或有餐廳是我們並沒有記錄，可以透過這張表格遞交給我們，經過審批後會上傳至資料庫，給用戶們查看。
            </div>
          </div>
        </div>
        <div class="row card">
          <div class="card-body">
            <div class="col">
              <h4 class="card-title fw-bold">新餐廳資訊</h4>
        ...
        <div class="row card">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <h5 class="card-title">餐廳的官方資料 (如需要)</h5>
              </div>
            </div>
            <div class="row">
              <div class="col-2">
        ...
        <div class="row">
          <div class="col text-end">
            <button type="button" class="btn btn-primary" onclick="appleNewRestaurant()">提交</button>
          </div>
        </div>
      </div>
    </div> <!-- Container -->
