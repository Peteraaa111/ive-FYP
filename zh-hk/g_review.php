...
// Start the SESSION
session_start();
include_once('/xampp/htdocs/travelhk.com/checklogin.php');
    ...
    <div class="container card">
      <div class="card-body">
        <div class="row card">
          <div class="card-body">
            <div class="col">
              <h4 class="card-title fw-bold">寫評價</h4>
        ...
        <div class="row card">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col">
                <input type="radio" class="btn-check" name="type_of_meal" id="type1" autocomplete="off" value="一星期">
                <label class="btn btn-outline-primary" for="type1">一星期</label>

                <input type="radio" class="btn-check" name="type_of_meal" id="type2" autocomplete="off" value="二星期或以上">
                <label class="btn btn-outline-primary" for="type2">二星期或以上</label>

                <input type="radio" class="btn-check" name="type_of_meal" id="type3" autocomplete="off" value="一個月或以上">
                <label class="btn btn-outline-primary" for="type3">一個月或以上</label>
        ...
        <div class="row">
          <div class="col text-end">
            <button type="button" class="btn btn-primary" onclick="submitguesthouserating('<?php echo $guesthouse_id ?>');">提交</button>
          </div>
        </div>
      </div>
    </div> <!-- Container -->
