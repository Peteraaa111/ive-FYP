...
<head>
  ...
  <title><?php echo $details['attraction_chinese_name']; ?> - 香港本地旅遊平台 | 本地遊</title>
...
<body>
  ...
  <section id="banner" class="padding-4rem mb-4">
    <div id="banner-background" class="bg-dark rounded-3" style="background-image: url(/data/site/attraction/<?php echo $details['attraction_id']; ?>/banner.jpg);"></div>
    <div id="banner-info" class="container py-5">
      <div class="row">
        <div class="col-md-12 text-center">
          <h1 class="fw-bold">
            <?php echo $details['attraction_chinese_name']; ?>
          </h1>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 text-center">
          <h2>
            <?php echo $details['attraction_english_name']; ?>
          </h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <a id="showtext" style="margin-left:5px" href="a_review.php?id=<?php echo $attraction_id;?>">
      ...
      <div class="row">
        <div class="col-md-4">
          <div id="r_info" class="card">
            <div class="card-body">
              <h5 class="card-title fw-bold">景點資訊</h5>
              <hr class="py-1">
        ...
        <div class="col-md-8">
          <div class="card">
            <div id="r_photos" class="card-body">
              <h5 class="card-title fw-bold">景點照片</h5>
              <hr class="py-1">
              <div class="photos">
                <ul class="list">
                  <li class="item">
                    <a href="#">
                      <div class="content" style="background-image: url(/assets/img/test-only/attraction/200x200.png);"></div>
                    </a>
                  </li>
                  <li class="item">
                    <a href="#">
  ...
  <section id="review" class="mb-4">  
    <div class="container">
      <div class="row">
        <div class="col-md-12">      
            <?php
            $sql = "SELECT ac.`attraction_id`, ac.`content`, ac.`create_datetime` AS `date`, a.`nickname` AS `name`, ac.title,ac.comment_id, ac.environment_rating, ac.service_rating, ac.hygiene_rating, ac.date_of_visit, ac.status
                    FROM `attraction_comment` ac
                    INNER JOIN `account` a ON ac.`account_id` = a.`account_id`
                    WHERE ac.status = 1 AND ac.`attraction_id` = {$details['attraction_id']};";
              ...
              <div class="card-body">
                <div class="row review-content">
                    ...
                    <div class="col-md-2">
                      ...
                      <div>
                        <div>遊覽日期 <?php echo $comment_rc["date_of_visit"]; ?> </div>
                      </div>
                    </div>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          $result = itemToItem($details['attraction_id'], 10);
          echo '
          <div class="row mb-2">
            <div class="col-md-12">
              <h5 class="pb-2 bg-light border-bottom border-3 border-info">其他人感到興趣的景點</h5>
            </div>
          </div>
