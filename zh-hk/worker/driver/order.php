            ...
            <form id="driver-booking-form" enctype="multipart/form-data" method="POST">
              ...
              <h5 class="card-title">接送地點</h5>
                ...
                if ($details['driver_id'] == null) {
                  ...
                  ';
                } else if ($details['driver_id'] == $_SESSION['driver_id'] && $details['status'] == 1) {
                  echo '
                  <div class="row">
                    <div class="col">
                      <div class="card">
                        <div class="card-body">
                          <div class="row">
                            <div class="col d-flex justify-content-center">
                              <h1 class="fw-bold text-primary">你已經接受此預約</h1>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col d-flex justify-content-center">
                              <button type="button" class="btn btn-outline-success fw-bold fs-4 me-2" onclick="finishDriverBooking()">工作完成</button>
                              <button type="button" class="btn btn-danger fw-bold fs-4" onclick="cancelBooking()">工作取消</button>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  ';
                } else if ($details['driver_id'] == $_SESSION['driver_id'] && $details['status'] == 2) {
                  echo '
                  <div class="row">
                    <div class="col">
                      <div class="card">
                        <div class="card-body d-flex justify-content-center">
                          <h1 class="fw-bold text-success">此工作已完成</h1>
                        </div>
                      </div>
                    </div>
                  </div>
                  ';
                } else if ($details['driver_id'] == $_SESSION['driver_id'] && $details['status'] == 3) {
                  echo '
                  <div class="row">
                    <div class="col">
                      <div class="card">
                        <div class="card-body d-flex justify-content-center">
                          <h1 class="fw-bold text-danger">此工作已取消</h1>
                        </div>
                      </div>
                    </div>
                  </div>
