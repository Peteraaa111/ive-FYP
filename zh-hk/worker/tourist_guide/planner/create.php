...
<head>
  ...
  <link href="/css/tourist_guide_planner.css" rel="stylesheet">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form id="scheduleForm" method="POST">
            ...
            <div id="createDiv">
              <button type="button" class="btn btn-primary" onclick="createSchedule()" id="createButton">創建行程</button>
            </div>
          </form>
          ...
          <div id="aroundBody" class="d-flex flex-column align-items-stretch flex-shrink-0 bg-white" style="width: 330px;"></div>
