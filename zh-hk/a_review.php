    ...
    <div class="container card">
      <div class="card-body">
        <div class="row card">
          <div class="card-body">
            <div class="col">
              <h4 class="card-title fw-bold">評分</h4>
        ...
        <div class="row">
          <div class="col text-end">
            <button type="button" class="btn btn-primary" onclick="submitattractionrating('<?php echo $attraction_id ?>');">提交</button>
          </div>
        </div>
      </div>
    </div> <!-- Container -->
