        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-10 offset-1">
              <h3 class="text-secondary">新景點資訊</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-md-10 offset-1">
                ...
                <tbody>
                  ...
                  ?>
                    <tr onclick="window.location='details.php?id=<?php echo $rc['id'] ?>';">
                      ...
                      <td scope="row"><?php echo $rc['attraction_chinese_name'] ?></td>
                      <td scope="row"><?php echo $rc['attraction_english_name'] ?></td>
