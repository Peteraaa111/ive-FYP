...
// Get the details
$id = $_GET['id'];
$sql = "SELECT * FROM `restaurant_discover` WHERE `id` = $id";
$rs = mysqli_query($conn, $sql);
$rc = mysqli_fetch_assoc($rs);

// Get the restaurant cuisine
$sql = "SELECT *  FROM `restaurant_discover_cuisine` WHERE `id` = $id";
$rs = mysqli_query($conn, $sql);
$types = mysqli_fetch_assoc($rs);

// Get the restaurant type
$sql = "SELECT *  FROM `restaurant_discover_type` WHERE `id` = $id";
$rs = mysqli_query($conn, $sql);
$types = mysqli_fetch_assoc($rs);

// Get the payment method
$sql = "SELECT * FROM `restaurant_discover_payment_method` WHERE `id` = $id";
$rs = mysqli_query($conn, $sql);
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-8">
                      <h3 class="card-title text-secondary">新餐廳資訊 (ID: <?php echo $rc['id']; ?>)</h3>
                    </div>
                    <div class="col-md-4">
                      <div class="text-end">
                          <?php
          ...
          <div class="row">
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-secondary">餐廳資料</h4>
                  <!-- restaurant name -->
                  <div class="row">
                    <div class="col-md-2">
                      餐廳名稱<span class="text-danger">*</span>
                    </div>
                    <div class="col-md-5">
                      <input type="text" class="form-control" value="<?php echo $rc['restaurant_chinese_name']; ?>" readonly>
                    </div>
                    <div class="col-md-5">
                      <input type="text" class="form-control" value="<?php echo $rc['restaurant_english_name']; ?>" readonly>
                    </div>
                  </div>
                  <!-- District -->
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-2">
                    菜式<span class="text-danger">*</span>
                    </div>
                    <div class="col-md-10">
                      <?php
                      $sql = "SELECT * FROM `cuisine_list`;";
                      $rs = mysqli_query($conn, $sql);

                      while ($type = mysqli_fetch_assoc($rs)) {
                        if ($type['cuisine_id'] == '0') {
                          // empty
                        } else {
                          echo '<div class="form-check form-check-inline">';
                          echo '<input class="form-check-input type" type="checkbox" id="' . str_replace(' ', '', $type['en']) . '" value="' . $type['cuisine_id'] . '" name="type[]"' . (in_array($type['cuisine_id'], $types) ? 'checked="checked"' : '') . ' disabled>';
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      餐廳類型<span class="text-danger">*</span>
                    </div>
                    <div class="col-md-10">
                      <?php
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      座位數目<span class="text-danger">*</span>
                    </div>
                    <div class="col-md-10">
                      <div class="input-group">
                        <input type="number" class="form-control" id="seats" name="seats" autocomplete="off" value="<?php echo $rc['number_of_seats']; ?>" readonly>
          ...
          <div class="row">
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-secondary">餐廳照片</h4>
                  <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                      <?php
                      echo '<a href="/data/discovery/restaurant/'.$id.'/photo1.jpg" class="btn btn-primary">查看相片</a>';
                      ?>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <?php
                      $path = $_SERVER['DOCUMENT_ROOT']."/data/discovery/restaurant/$id/photo2.jpg";
                      if (file_exists($path)) {
                        echo '<a href="/data/discovery/restaurant/'.$id.'/photo2.jpg" class="btn btn-primary">查看相片</a>';
                      } else {
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                    <?php
                      $path = $_SERVER['DOCUMENT_ROOT']."/data/discovery/restaurant/$id/photo3.jpg";
                      if (file_exists($path)) {
                        echo '<a href="/data/discovery/restaurant/'.$id.'/photo3.jpg" class="btn btn-primary">查看相片</a>';
                      } else {
                        echo '<a href="#" class="btn btn-secondary" disabled>沒有相片</a>';
                      }
                      ?>
          ...
          <!-- Official information on restaurant -->
          <div class="row">
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-secondary">餐廳的官方資料 (如需要)</h4>
                  <!-- Website -->
                  <div class="row">
                    <div class="col-md-2">
            ...
            <div class="row">
              <div class="col-md-10 offset-1">
                <div class="card">
                  <div class="card-body">
                    <div class="text-end">
                      <button type="button" class="btn btn-success" onclick="confirmRestaurantDiscovery('.$rc['id'].', \'accept\')">接受</button>
                      <button class="btn btn-danger" onclick="confirmRestaurantDiscovery('.$rc['id'].', \'reject\')">拒絕</button>
                    </div>
                  </div>
                </div>
              </div>
