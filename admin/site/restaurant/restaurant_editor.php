...
$sql = "SELECT *, rsl.`zh-hk` AS `status`
        FROM `restaurant` r
...
// get restaurant's equipments
$equipment_sql = "SELECT * FROM `restaurant_equipment`
                    WHERE restaurant_id = '$restaurant_id';";
$equipment_rs = mysqli_query($conn, $equipment_sql);
$equipments = array();
while ($equipmentT = mysqli_fetch_assoc($equipment_rs)) {
  $equipments[] = $equipmentT['equipment_id'];
}
?>
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10">
                            <select class="form-select" id="district" name="district">
                              <option value="" disabled hidden><?php echo $rc['district'] ?></option>
                              <?php
                        ...
                        <div class="row">
                          <div class="col-md-12 text-center">
                            <button type="button" class="btn btn-primary" onclick="adminUpdateRestaurantInfo(<?php echo $restaurant_id; ?>);">更新</button>
                          </div>
                        </div>
                      </div>
                    </div><!-- End of row -->
              ...
              <form id="setting">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12 text-center">
                        <button type="button" class="btn btn-primary" onclick="adminUpdateRestaurantStatus(<?php echo $restaurant_id; ?>);">更新</button>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2 text-center">
                        <button type="button" class="btn btn-primary" onclick="adminUpdateRestaurantStorefront(<?php echo $restaurant_id; ?>);">更新</button>
                      </div>
                      <div class="col-md-3">
                        <a href="/data/site/restaurant/<?php echo $restaurant_id; ?>/storefront.jpg" class="btn btn-primary">查看目前門面照片</a>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-2">
                      ...
                      <div class="col-md-2 text-center">
                        <button type="button" class="btn btn-primary" onclick="adminUpdateRestaurantBanner(<?php echo $restaurant_id; ?>);">更新</button>
                      </div>
                      <div class="col-md-3">
                        <a href="/data/site/restaurant/<?php echo $restaurant_id; ?>/banner.jpg" class="btn btn-primary">查看目前海報照片</a>
                      </div>
                    </div>
                  </div>
                </div>
