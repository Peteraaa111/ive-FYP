...
<head>
  ...
  <title>導遊帳號 (ID:<?php echo $account_id; ?>) - 管理頁面</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <h3 class="card-title text-secondary">
                        導遊帳號資料 <?php echo '(ID:'.$rc['account_id'].')'; ?>
                      </h3>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <form id="account-details">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-10">
                        <input type="text" name="nickname" id="nickname" class="form-control" value="<?php echo $rc['nickname']; ?>" readonly>
                      </div>
                    </div>
                    <!-- Gender -->
                    <div class="row">
          ...
          <!-- Working record (Customer booking) -->
          <div class="row">
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="card-title text-secondary">工作紀錄 (用戶預約服務)</h3>
                    </div>
                  </div>
                  <!-- Table -->
                  <div class="row">
                    <div class="col-md-12">
                      <table id="bookingRecord" class="table table-hover">
                        <thead>
                          <th>編號</th>
                          <th>狀態</th>
                          <th>完成日期</th>
                        ...
                        <tbody>
                          ...
                          $sql = "SELECT *, s.`zh-hk` AS `status`
                                    FROM `itinerary_booking` booking
                                    INNER JOIN `booking_status` s ON booking.`status` = s.`status_id`
                                    WHERE `tourguide_id` = {$rc['account_id']}
                                    ORDER BY `create_datetime` ASC;";
                          $rs = mysqli_query($conn, $sql);
                          while ($booking = mysqli_fetch_assoc($rs)) {
                            echo "<tr>";
                            echo "<td>".$booking['booking_id']."</td>";
                            echo "<td>".$booking['status']."</td>";
                            echo "<td>".$booking['complete_datetime']."</td>";
                            echo "</tr>";
                          }
                          ?>
                        </tbody>
            ...
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="card-title text-secondary">工作紀錄 (旅行團服務)</h3>
                    </div>
                  </div>
                  <!-- Table -->
                  <div class="row">
                    <div class="col-md-12">
                      <table id="tourGroupRecord" class="table table-hover">
                        <thead>
                          <th>編號</th>
                          <th>旅行團名稱</th>
                          <th>出發日期</th>
                        ...
                        <tbody>
                          <?php
                          // Get the tour group record
                          $sql = "SELECT *, s.`zh-hk` AS `status`
                                    FROM `tourguide_tourgroup` tour
                                    INNER JOIN `itinerary_status` s ON tour.`status` = s.`status_id`
                                    WHERE `account_id` = {$rc['account_id']}
                                    ORDER BY `create_datetime` ASC;";
                          $rs = mysqli_query($conn, $sql);
                          while ($tour = mysqli_fetch_assoc($rs)) {
                            echo "<tr>";
                            echo "<td>".$tour['tourgroup_id']."</td>";
                            echo "<td>".$tour['subject']."</td>";
                            echo "<td>".$tour['start_date']."</td>";
                            echo "<td>".$tour['start_time']."</td>";
                            echo "<td>".$tour['status']."</td>";
                            echo "</tr>";
                          }
                          ?>
                        </tbody>
