...
<head>
  ...
  <title>司機帳號 (ID:<?php echo $account_id; ?>) - 管理頁面</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <h3 class="card-title text-secondary">
                        司機帳號資料 <?php echo '(ID:'.$rc['account_id'].')'; ?>
                      </h3>
                    </div>
          ...
          <!-- Account details -->
          <div class="row" id="account-details-row">
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  <!-- Title -->
            ...
            <div class="col-md-10 offset-1">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="card-title text-secondary">工作紀錄</h3>
                    </div>
                  </div>
                  <!-- Table -->
                  <div class="row">
