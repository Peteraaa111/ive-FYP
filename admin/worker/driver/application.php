...
$details_sql = "SELECT * FROM `driver_application` WHERE `id` = $id;";
...
if($details['status'] == 1){
  $update_status_sql = "UPDATE `driver_application`
                          SET `status` = 2
                          WHERE `id` = '".$details['id']."';";
...
<head>
  ...
  <title>司機工作申請申請 編號: <?php echo $details['id']; ?> - 管理頁面</title>
            ...
            <div class="col-md-10 offset-1">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-8">
                      <h3 class="text-secondary">司機工作申請表 (ID: <?php echo $details['id']; ?>)</h3>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h3 class="text-secondary">車輛資料</h3>
                  <div class="row">
                    <div class="col-md-2">
                      座位數目
                      <span class="text-danger">*</span>
                    ...
                    <div class="col-md-10">
                      <div class="input-group">
                        <input type="number" name="seats" id="seats" class="form-control" value=<?php echo '"' . $details['seat'] . '"'; ?> readonly>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10">
                      <input type="text" name="license-plate-number" id="license-plate-number" class="form-control" value=<?php echo '"' . $details['license_plate_number'] . '"'; ?> readonly>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                      <a class="btn btn-primary" href="<?php echo "/data/job_application/driver/" . $details['id'] . "/vehicle_exterior.jpg"; ?>" target="_blank">查看相片</a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                      <a class="btn btn-primary" href="<?php echo "/data/job_application/driver/" . $details['id'] . "/vehicle_inside.jpg"; ?>" target="_blank">查看相片</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div id="confirmation" class="card">
                <div class="card-body text-end">
                  <button type="button" id="accept-btn" class="btn btn-success" onclick="confirmDriverApplication('<?php echo $details['id']; ?>', 'accept', '<?php echo $details['email']; ?>');">接受</button>
                  <button type="button" id="reject-btn" class="btn btn-danger" onclick="confirmDriverApplication('<?php echo $details['id']; ?>', 'reject', '<?php echo $details['email']; ?>');">拒絕</button>
                </div>
              </div>
            </div>
          </div>
