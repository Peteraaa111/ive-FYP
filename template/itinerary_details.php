...
<head>
  ...
  <script src="/js/itinerary_details.js"></script>
</head>
        ...
        <div class="row card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-2">
                <button type="button" class="btn btn-success" id="booking-btn" onclick="bookingRequest()" style="width:100%">預約服務</button>
              </div>
              <div class="col-1">
          ...
          <div class="row card">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-5">
                  <input type="text" class="form-control" id="eng-itinerary-name" name="eng-itinerary-name" placeholder="英文" value="<?php echo $details['itinerary_english_name']; ?>" />
                </div>
              </div>
            </div>
          </div><br>
