...
<head>
  ...
  <script src="/js/itinerary_booking.js"></script>
</head>
  ...
  <div class="container" id="searchHeader">
    <div class="container card">
      <div class="card-body">
        ...
        <form id="create-itinerary-booking-request-form" enctype="multipart/form-data" method="POST">
          ...
          <div class="row card">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-5">
                  <input type="text" class="form-control" id="eng-itinerary-name" name="eng-itinerary-name" placeholder="英文" value="<?php echo $details['itinerary_english_name']; ?>" disabled />
                </div>
              </div>
            </div>
          </div><br>
